...
if __name__ == '__main__':
    ...
    parser.add_argument('--embedding_model_name', type=str, default='sbert', choices=['ada002', 'sbert', 'e5','bert'], help='embedding model name')
    parser.add_argument('--reconstruction_models', type=str, default='llama3-8b,qwen2-7b,phi3-8b,gemma2-9b', help='reconstruction models names')
    parser.add_argument('--iterations', type=int, default=5, help='iterations number')
    ...
    print(f'result (True if Hallucination else False):\n{res}')